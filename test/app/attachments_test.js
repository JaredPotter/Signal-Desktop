...
describe('Attachments', () => {
  ...
  describe('getTempPath', () => {
    ...
    it('returns the absolute path to the temp attachments path', () => {
      ...
      const expectedPathResult = path.join(root, 'attachments.temp');
  ...
  describe('createWriterForTempAttachment', () => {
    ...
    it('creates a temp file on disk', async () => {
      ...
      // Test.
      const payload = await Attachments.createWriterForTempAttachment(
        tempPathResult
      )(mockFile);
  ...
  describe('createDeleterForTempAttachment', () => {
    ...
    it('deletes a temp file from disk', async () => {
      // Setup.
      const filename = 'myFile.jpg';
      const tempFilePathFull = path.join(
        tempRootDirectory,
        'attachments.temp',
        filename
      );
      ...
      // Test.
      await Attachments.createDeleterForTempAttachment(
        path.join(tempRootDirectory, 'attachments.temp')
      )(filename);
